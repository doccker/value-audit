...
import { appendNote, buildDoPrompt, exportReport, listText, readJournalTail, todoText } from "./subcommands";
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    async execute(_id, params, _signal, _onUpdate, ctx) {
      ...
      applied.state.audits[applied.state.audits.length - 1].unverifiedCitations = cite.missing.length;
